...
class ScrollComponent {
  ...
  constructor(_element: HTMLElement, options: ScrollOptions) {
    ...
    this.update();
    // this.element.setAttribute('data-mz-scrolltop', 'true')
    DataUtil.set(this.element, "scroll", this);
  }

  private getOption = (name: string) => {
    if (this.element.hasAttribute("data-mz-scroll-" + name) === true) {
      const attr = this.element.getAttribute("data-mz-scroll-" + name) || "";
  ...
  public update = () => {
    ...
    if (
      ...
      !this.element.hasAttribute("data-mz-scroll-activate")
    ) {
      this.setupHeight();
  ...
  public static destroyAll(attr: string = '[data-mz-scroll="true"]') {}

  public static bootstrap(attr: string = '[data-mz-scroll="true"]') {
  ...
  public static reinitialization(attr: string = '[data-mz-scroll="true"]') {
    ScrollComponent.createInstances(attr);
  }

  public static updateAll() {
    const elements = document.body.querySelectorAll('[data-mz-scroll="true"]');
    elements.forEach((element: Element) => {

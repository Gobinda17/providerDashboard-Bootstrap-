...
class MenuComponent {
  ...
  constructor(_element: HTMLElement, options: MenuOptions) {
    ...
    // this.element.setAttribute('data-mz-menu', 'true')
  ...
  private _setTriggerElement = () => {
    const target = document.querySelector(
      `[data-mz-menu-target="#${this.element.getAttribute("id")}"`
    );

    if (target) {
      this.triggerElement = target as HTMLElement;
    } else if (this.element.closest("[data-mz-menu-trigger]")) {
      this.triggerElement = this.element.closest(
        "[data-mz-menu-trigger]"
      ) as HTMLElement;
    } else if (
  ...
  private _getItemOption = (item: HTMLElement, name: string) => {
    ...
    if (item && item.hasAttribute("data-mz-menu-" + name)) {
      const attr = item.getAttribute("data-mz-menu-" + name) || "";
  ...
  private _getItemElement = (
    ...
    if (_element.hasAttribute("data-mz-menu-trigger")) {
      return _element;
    }
    ...
    const item = _element.closest<HTMLElement>(
      ".menu-item[data-mz-menu-trigger]"
    );
    if (item) {
      return item;
    }
  ...
  private _getItemChildElement = (item: HTMLElement): HTMLElement | null => {
    ...
    if (selector) {
      //element = selector.querySelector('.show.menu-item[data-mz-menu-trigger]');
  ...
  private _hasItemSub = (item: HTMLElement) => {
    return (
      ...
      item.hasAttribute("data-mz-menu-trigger")
    );
  };
  ...
  public static hideDropdowns = (skip: HTMLElement | undefined) => {
    const items = document.querySelectorAll<HTMLElement>(
      ".show.menu-dropdown[data-mz-menu-trigger]"
    );
  ...
  public static initGlobalHandlers = () => {
    ...
    document.addEventListener("click", (e) => {
      const menuItems = document.querySelectorAll(
        '.show.menu-dropdown[data-mz-menu-trigger]:not([data-mz-menu-static="true"])'
      );
    ...
    DOMEventHandlerUtil.on(
      document.body,
      '.menu-item[data-mz-menu-trigger] > .menu-link, [data-mz-menu-trigger]:not(.menu-item):not([data-mz-menu-trigger="auto"])',
      "click",
    ...
    DOMEventHandlerUtil.on(
      document.body,
      ".menu-item:not([data-mz-menu-trigger]) > .menu-link",
      "click",
      function (this: HTMLElement, e: Event) {
        e.stopPropagation();
    ...
    window.addEventListener("resize", () => {
      ...
      throttle(
        ...
        () => {
          ...
          const elements = document.querySelectorAll('[data-mz-menu="true"]');
          elements.forEach((el) => {
  ...
  public static bootstrap = () => {
    ...
    MenuComponent.createInstances('[data-mz-menu="true"]');
  };

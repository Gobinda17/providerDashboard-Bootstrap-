...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    const elementTargetAttr = this.element.getAttribute(
      "data-mz-toggle-target"
    );
    if (elementTargetAttr) {
      this.target = document.querySelector(elementTargetAttr);
    }
    const elementToggleAttr = this.element.getAttribute("data-mz-toggle-state");
    this.state = elementToggleAttr || "";
    const elementModeAttr = this.element.getAttribute("data-mz-toggle-mode");
    this.mode = elementModeAttr || "";
    this.attribute =
      "data-mz-" + this.element.getAttribute("data-mz-toggle-name");
  ...
  public static reinitialization = () => {
    ToggleComponent.createInstances("[data-mz-toggle]");
  };

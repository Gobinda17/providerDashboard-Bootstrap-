...
class StickyComponent {
  ...
  constructor(_element: HTMLElement, options: StickyOptions) {
    ...
    this.instanceName = this.element.getAttribute("data-mz-sticky-name");
    this.attributeName = "data-mz-sticky-" + this.instanceName;
    this.attributeName2 = "data-mz-" + this.instanceName;
  ...
  private getOption = (name: string) => {
    const dataStickyAttr = "data-mz-sticky-" + name;
  ...
  public static bootstrap(attr: string = '[data-mz-sticky="true"]') {
    StickyComponent.createInstances(attr);
  }

  public static reInitialization(attr: string = '[data-mz-sticky="true"]') {
    StickyComponent.createInstances(attr);
  }
}
